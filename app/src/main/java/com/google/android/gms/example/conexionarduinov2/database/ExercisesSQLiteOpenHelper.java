 ...
 */
public class ExercisesSQLiteOpenHelper extends SQLiteOpenHelper {


    public ExercisesSQLiteOpenHelper(Context context, String name, SQLiteDatabase.CursorFactory factory, int version) {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String sqlNameTable = "CREATE TABLE " + Constans.NAME_TABLE_USER_DB + " ( " + Constans.ID_DB + " INTEGER PRIMARY KEY, " +
